...
const steps = [
  {
    ...
    description: "Support requests are instantly logged and assigned to the right department.",
    icon: "/TicketingIcon6.svg",
    color: "#7c6ff7",
  },
  {
    number: "02",
    title: "Priority Assigned",
    description: "Tickets are categorized based on urgency, impact, and SLA requirements.",
    icon: "/TicketingIcon7.svg",
    color: "#6a5ae0",
  },
  {
    number: "03",
    ...
    icon: "/TicketingIcon8.svg",
    color: "#5647c8",
  },
  {
    number: "04",
    title: "Resolution & Closure",
    description: "Resolved tickets are closed with complete tracking history and performance visibility.",
    icon: "/TicketingIcon9.svg",
    color: "#3d2fa8",
  },
]

const TicketWorkflowSection = () => {
  return (
    <section
      className="overflow-hidden px-5 py-20 md:px-8 lg:py-24"
      style={{ background: "linear-gradient(125deg,#ffffff 0%,#ffffff 52%,#eeeeff 100%)" }}
    >
      <div className="mx-auto grid max-w-[1040px] items-center gap-14 lg:grid-cols-[430px_1fr] lg:gap-20">
        <div>
          <span className="inline-flex rounded-full bg-[#456cff] px-5 py-2 text-sm font-medium text-white shadow-[0_12px_30px_rgba(63,108,255,0.22)]">
            Smart Ticket Workflow
          </span>

          <h2 className="mt-9 max-w-[380px] text-[46px] font-bold leading-[1.02] text-[#172283] sm:text-[58px]">
            From Request
            <br />
            to <span className="text-[#456cff]">Resolution</span>
          </h2>

          <p className="mt-6 max-w-[380px] text-base leading-snug text-[#6c78bd]">
            Track every support request through a structured workflow designed to improve response time, accountability, and operational clarity.
          </p>
        </div>
...
export default TicketWorkflowSection
