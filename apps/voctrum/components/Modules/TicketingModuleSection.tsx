...
const TicketingModuleSection = () => {
  return (
    <section className="bg-[#fbf8ff] px-5 py-20 md:px-8 lg:py-24">
      <div className="mx-auto grid max-w-[1040px] items-center gap-12 lg:grid-cols-[440px_1fr] lg:gap-16">
        <ModuleCardImage src="/ImageCard4.jpg" alt="Ticketing module card" />

        <div className="mx-auto w-full max-w-[520px] lg:mx-0">
          <h2 className="text-[42px] font-bold leading-none text-[#7648d8] md:text-5xl">
            Ticketing
          </h2>
          ...
          >
            Explore Ticketing
            <span className="flex h-6 w-6 items-center justify-center rounded-full bg-white text-[#7648d8]">
              <ArrowRight className="h-4 w-4" strokeWidth={2.5} />
            </span>
          </Link>

          <Accordion type="single" collapsible defaultValue="performance" className="mt-12 gap-3 md:mt-16">
            <AccordionItem
              value="priority"
              className="overflow-hidden rounded-2xl border border-[#eee5fb] bg-white shadow-[0_18px_50px_rgba(118,72,216,0.08)]"
            >
              ...
              <AccordionContent className="ml-9 max-w-[360px] px-5 pb-5 text-sm leading-snug text-[#6879bb]">
                Tickets can be organized by urgency, SLA targets, assignment rules, and customer impact so teams handle the right work first.
              </AccordionContent>
            </AccordionItem>

            <AccordionItem value="performance" className="overflow-hidden rounded-2xl border-0 bg-[#edf1f8]">
              <AccordionTrigger className="min-h-[56px] items-center justify-start gap-4 px-5 py-0 text-left hover:no-underline [&_[data-slot=accordion-trigger-icon]]:hidden">
                <Plus className="h-5 w-5 shrink-0 text-[#315cff] group-aria-expanded/accordion-trigger:hidden" strokeWidth={2.6} />
                <Minus className="hidden h-5 w-5 shrink-0 text-[#13247c] group-aria-expanded/accordion-trigger:block" strokeWidth={2.6} />
                <span className="text-sm font-bold text-[#13247c]">
                  Can teams track ticket performance?
                </span>
              </AccordionTrigger>
              <AccordionContent className="ml-9 max-w-[360px] px-5 pb-5 text-sm leading-snug text-[#6879bb]">
                Yes. Monitor resolution speed, workloads, and service efficiency in real time.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
...
export default TicketingModuleSection
