...
const StartWithAnalyticsSection = () => {
  return (
      ...
      <div className="mx-auto max-w-[1040px]">
        <div className="mx-auto max-w-[560px] text-center">
          <h2 className="text-[42px] font-bold leading-[1.05] text-[#172283] sm:text-[54px]">
            Make Every<br />Marketing Decision<br />With <span className="text-[#456cff]">Confidence</span>
          </h2>

          <p className="mt-4 text-sm leading-snug text-[#6c78bd] sm:text-base">
            Access real-time analytics, identify opportunities faster, and
            <br />
            improve performance across every social platform.
          </p>
...
export default StartWithAnalyticsSection
