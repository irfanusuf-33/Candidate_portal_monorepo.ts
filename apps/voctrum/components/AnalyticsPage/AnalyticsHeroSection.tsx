  ...
  return (
    <section className="bg-white px-1.5 py-3 sm:px-2">
      <div className="relative mx-auto min-h-[760px] max-w-[1582px] overflow-hidden rounded-[28px] border border-[#d6defd] px-5 pt-24 sm:rounded-[30px] sm:px-9">
        <Image src="/AnalyticsBgImg.png" alt="" fill priority className="pointer-events-none object-cover object-center" sizes="100vw" />
        ...
        <div className="relative z-10 mx-auto flex max-w-[760px] flex-col items-center text-center">
          ...
          >
            Track performance, uncover trends, and make informed decisions with real-time analytics and visual reporting.
          </motion.p>
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-[-40px] mx-auto h-[496px] w-[315px] sm:w-[380px]">
            ...
            <Image src="/CrmHeroSectionImg.png" alt="Analytics mobile workspace" fill priority className="object-contain object-bottom" sizes="(max-width: 640px) 320px, 395px" />
            ...
            <Image src="/AnalyticsIcon1.svg" alt="" width={300} height={300} className="absolute left-1/2 top-[220px] z-20 h-[180px] w-[180px] -translate-x-1/2 sm:top-[240px]" />
          </div>

          {/* Analytics image — right */}
          <motion.div
            initial={{ opacity: 0, x: 34 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.58, delay: 0.6 }}
            className="absolute right-[210px] top-[110px] z-20 max-md:hidden"
          >
            <Image src="/AnalyticsImg1.png" alt="Analytics Overview" width={640} height={740} className="h-[260px] w-auto object-contain" />
          </motion.div>
        </motion.div>
      </div>
    </section>
