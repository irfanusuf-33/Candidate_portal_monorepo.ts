  ...
  return (
    <>
      ...
      <section className="pointer-events-none relative z-20 -mb-[86px] h-[86px] overflow-visible bg-transparent">
        <div
          className="absolute left-1/2 -top-px z-10 h-[87px] w-[min(92vw,720px)] -translate-x-1/2 bg-white"
          style={{ clipPath: "polygon(0 0, 100% 0, 74% 100%, 26% 100%)" }}
        />

        <Link href="/" aria-label="Voctrum home" className="pointer-events-auto absolute left-1/2 top-0 z-20 -translate-x-1/2">
